...
const Booked = () => {
  ...
  const handleBooked = () => {
    ...
    fetch("https://sayeman-hotel-server.vercel.app/bookings", {
      method: "POST",
      headers: {
      ...
      .then((data) => {
        console.log(data);
        if (data.insertedId) {
          Swal.fire("Good job!", "Room Booked Successfully", "success");
        }
      })
      ...
      <div className="card w-1/2 mx-auto bg-base-100 shadow-xl">
        ...
        <div className="card-body">
          ...
          <p className=" text-2xl font-medium">
            Rack Rate:{" "}
            <span className="text-red-600">{price} BDT Per Night</span>
          </p>
          <div className="mb-4">
            <label
              for="datePicker"
